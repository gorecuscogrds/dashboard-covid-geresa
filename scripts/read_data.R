...
read_data_dis <- function() {
  data_dis <- fread("https://raw.githubusercontent.com/gorecuscogrds/dashboard-covid-geresa/main/data/source2_siscovid/output/data_distrital.csv", keepLeadingZeros = TRUE)
...
read_data_map_district <- function() {
  cusco_map_district <- jsonlite::fromJSON("https://raw.githubusercontent.com/gorecuscogrds/dashboard-covid-geresa/main/data/source4_mapas/districts.geojson", simplifyVector = FALSE)
}
...
read_data_beds <- function() {
  ...
  data_beds <- fread("https://raw.githubusercontent.com/gorecuscogrds/dashboard-covid-geresa/main/data/source1_camas/output/camas.csv")
...
read_semaforo <- function() {
  data_semaforo <- fread("https://raw.githubusercontent.com/gorecuscogrds/dashboard-covid-geresa/main/data/source3_semaforo/traffic_light.csv")
}
