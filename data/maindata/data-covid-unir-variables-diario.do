...
* Exportar a CSV
sort ubigeo fecha
export delimited using "${maindata}/data_distrital.csv", replace
...
* Exportar a CSV
export delimited using "${maindata}/data_provincial.csv", replace
...
* Exportar a CSV
export delimited using "${maindata}/data_regional.csv", replace
